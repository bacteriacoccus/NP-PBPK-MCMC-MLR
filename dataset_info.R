...
read_observation_data <- function(np_name) {
  if (np_name == "Au: Study1_12nm_0.85mg/kg") {
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/gold/R_input_mouse_Study1_12nm.csv")
    Obs.df <- Obs.df[1:7,]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/gold/R_input_mouse_Study1_23nm.csv")
    Obs.df <- Obs.df[1:7,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/gold/R_input_mouse_study1_100nm.csv")
    Obs.df <- Obs.df[1:7,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    ...
    #--------------------------Study 2: 34.6nm------------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/gold/Study2_PEG_coated_AuNPs_34.6nm.csv") 
    Obs.df <- Obs.df[1:6,]
    pathway <- Obs.df$Input.pathway[1]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    #--------------------------Study 3: 55.5nm------------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/gold/Study2_PEG_coated_AuNPs_55.5nm.csv") 
    Obs.df <- Obs.df[1:8,]
    pathway <- Obs.df$Input.pathway[1]
    PDOSE = Obs.df$Dose..mg.kg.[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    #--------------------------Study 3: 77.1nm------------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/gold/Study2_PEG_coated_AuNPs_77.1nm.csv") 
    Obs.df <- Obs.df[1:8,]
    PDOSE = Obs.df$Dose..mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    #--------------------------Study 3: 82.6nm------------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/gold/Study2_PEG_coated_AuNPs_82.6nm.csv") 
    Obs.df <- Obs.df[1:8,]
    PDOSE = Obs.df$Dose..mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/gold/Study3_Gold dextran_h.csv") 
    Obs.df <- Obs.df[1:5,]
    pathway <- Obs.df$Input.pathway[1]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/gold/Study3_Gold dextran_l.csv") 
    Obs.df <- Obs.df[1:5,]
    pathway <- Obs.df$Input.pathway[1]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/silica/Study1_125I-SiNPs 20nm.csv")
    Obs.df <- Obs.df[1:5,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/silica/Study1_125I-SiNPs 80nm.csv")
    Obs.df <- Obs.df[1:5,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/GO/Study1_125I-NGS-PEG 10-30nm.csv")
    Obs.df <- Obs.df[1:5,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/GO/Study2_125I-s-GO 243nm.csv")
    Obs.df <- Obs.df[1:5,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    Obs.df <- read.csv(file = "dataset_1/tk/mouse/GO/Study2_125I-l-GO 914nm.csv")
    Obs.df <- Obs.df[1:5,]
    PDOSE <- Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    #------------------TiO2: Study1: 385 nm-------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/TiO2/Study1-TiO2.csv") 
    Obs.df <- Obs.df[1:5,]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    #------------------TiO2: Study1: 100 nm-------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/TiO2/Study2-TiO2.csv") 
    Obs.df = Obs.df[1:3,]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    ...
    #------------------IO: Study1: 29 nm-------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/iron/Study2_EDT_IONP_29nm.csv") 
    Obs.df <- Obs.df[1:4,]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
    ...
    #------------------IO: Study1: 29 nm-------------------------
    Obs.df <- read.csv(file ="dataset_1/tk/mouse/iron/Study3_USPIO_41nm.csv") 
    Obs.df <- Obs.df[1:12,]
    PDOSE = Obs.df$Dose.mg.kg.[1]
    pathway <- Obs.df$Input.pathway[1]
    Obs.df <- Obs.df[c("Time","CL","CS","CK","Clung")]
